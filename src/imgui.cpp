...
// Wrapper for ext/stb_textedit.h to edit text (our wrapper is for: statically sized buffer, single-line, wchar characters. InputText converts between UTF-8 and wchar)
namespace ImGuiStb
{
...
#endif
#define STB_TEXTEDIT_MOVEWORDLEFT   STB_TEXTEDIT_MOVEWORDLEFT_IMPL    // They need to be #define for ext/stb_textedit.h
...
// We don't use an enum so we can build even with conflicting symbols (if another user of ext/stb_textedit.h leak their STB_TEXTEDIT_K_* symbols)
...
#include "imgui/ext/stb_textedit.h"
...
#endif
#include "imgui/ext/stb_rect_pack.h"
...
#endif
#include "imgui/ext/stb_truetype.h"
